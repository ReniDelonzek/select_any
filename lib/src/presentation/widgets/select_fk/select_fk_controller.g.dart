...
mixin _$SelectFKController on _SelectFKBase, Store {
  Computed<Map<String, dynamic>?>? _$objComputed;

  @override
  Map<String, dynamic>? get obj =>
      (_$objComputed ??= Computed<Map<String, dynamic>?>(() => super.obj,
              name: '_SelectFKBase.obj'))
          .value;
  ...
  final _$_objAtom = Atom(name: '_SelectFKBase._obj');

  @override
  Map<String, dynamic>? get _obj {
    _$_objAtom.reportRead();
    return super._obj;
  }

  @override
  set _obj(Map<String, dynamic>? value) {
    _$_objAtom.reportWrite(value, super._obj, () {
      super._obj = value;
    });
  }
